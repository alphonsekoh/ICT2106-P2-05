...
namespace PainAssessment.Areas.ModuleTwo.Controllers
{
    ...
    public class PatientController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,patientName,patientAge,condition,gender,consultationID")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,patientName,patientAge,condition,gender,consultationID")] Patient patient)
        {
            if (id != patient.Id)
            {
                return NotFound();
